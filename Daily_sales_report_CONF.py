...
# Example app
st.title("Daily Sales Report Cleaner for CONFED")
st.write("Hello, this is a daily sales cleaner web app for CONFED!")
...
if uploaded_file1 is not None and uploaded_file2 is not None:
    ...
    columns_to_fill_file2 = ['Year', 'Month', 'Week', 'Date', 'Day of Week', 'Terminal', 'Customer Type']    
